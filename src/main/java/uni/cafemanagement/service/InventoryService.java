...
public class InventoryService {
    ...
    public InventoryService(MenuProductRepository menuProductRepository, InventoryProductRepository inventoryProductRepository, TransactionRepository transactionRepository) {
    ...
    // Pobierz produkt z inwentarza po ID
